...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/gb-beedemo-dev-org/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>gb-beedemo-dev-org</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>gb-beedemo-dev-org</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/gb-beedemo-dev-org/pipeline-template-catalog.git</repositoryUrl>
              <traits>
